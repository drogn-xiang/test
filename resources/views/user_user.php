...
<script src="../resources/views/js/user_user.js"></script>
<?php
    session_start();
    echo "<script>INP='{$_SESSION['user']}';</script>";
?>
<div class="create_user">
    <table>
        <tr>
            <td><label for="name">用户名:</label></td>
            <td><input name="name" id="name" type="text" disabled></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                <select name="pow" id="pow" disabled>
        ...
        <tr>
            <td colspan="2" style="text-align: center;">
                <div>
                    <button id="user_change">提交</button>
                </div>
            </td>
        </tr>
    </table>
