...
CREATE TABLE IF NOT EXISTS `admin` (
  ...
  `admin_pwd` varchar(255) NOT NULL DEFAULT '123456',
...
INSERT INTO `admin` (`id`, `admin_name`, `admin_pwd`, `name`, `pow`, `phone`) VALUES
('430381199411270458', 'xiang', '123456', '向研龙', '1', '15344425342'),
('430381199411270458', 'a123456', 'xiang', '阿', '0', '15344425342');
...
CREATE TABLE IF NOT EXISTS `checkin` (
  `start_admin` varchar(4) NOT NULL,
  `end_admin` varchar(4) DEFAULT NULL,
  `yajin` int(6) NOT NULL,
  `xiaofei` int(6) NOT NULL,
  `time_in` int(11) NOT NULL,
  `time_out` int(11) DEFAULT NULL,
  `room_name` varchar(6) DEFAULT NULL,
  `name` varchar(6) NOT NULL,
  `id` varchar(13) NOT NULL,
  `benjin` int(11) NOT NULL,
...
INSERT INTO `checkin` (`start_admin`, `end_admin`, `yajin`, `xiaofei`, `time_in`, `time_out`, `room_name`, `name`, `id`, `benjin`, `time`, `order_id`) VALUES
('向研龙', NULL, 200, 400, 1494000000, 1494229067, 'A0002', '相见', '1234567890', 400, 1, 1),
('向研龙', NULL, 300, 0, 1494229445, NULL, 'A0002', '希艾娜', '123456789', 400, 2, 2);
...
CREATE TABLE IF NOT EXISTS `room` (
  `name` varchar(6) NOT NULL,
  `mianji` int(4) NOT NULL,
  `chuangwei` int(2) NOT NULL,
  `kongtiao` int(2) NOT NULL,
  `dianshi` int(2) NOT NULL,
  `cesuo` int(2) NOT NULL,
  `err` varchar(40) NOT NULL,
  `price` int(5) NOT NULL,
  `checkin` int(4) NOT NULL,
  `dress` varchar(15) NOT NULL,
...
INSERT INTO `room` (`name`, `mianji`, `chuangwei`, `kongtiao`, `dianshi`, `cesuo`, `err`, `price`, `checkin`, `dress`, `type`) VALUES
('A0002', 100, 1, 0, 0, 0, '', 200, 1, '2', '普通房间'),
('A0001', 100, 2, 1, 0, 0, '', 200, 0, '1', '普通房间'),
('A10003', 100, 2, 1, 1, 1, '', 200, 0, '1', '主题套房'),
('A0003', 100, 2, 1, 1, 0, '', 200, 0, '1', '主题套房');
--
...
('def', 'hotel', 'admin', 'id', 1, NULL, 'NO', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'hotel', 'admin', 'admin_name', 2, NULL, 'NO', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_bin', 'varchar(255)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'hotel', 'admin', 'admin_pwd', 3, '123456', 'NO', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'hotel', 'admin', 'name', 4, NULL, 'NO', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'hotel', 'admin', 'pow', 5, NULL, 'NO', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'hotel', 'admin', 'phone', 6, NULL, 'NO', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'hotel', 'checkin', 'start_admin', 1, NULL, 'NO', 'varchar', 4, 12, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(4)', '', '', 'select,insert,update,references', ''),
('def', 'hotel', 'checkin', 'end_admin', 2, NULL, 'YES', 'varchar', 4, 12, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(4)', '', '', 'select,insert,update,references', ''),
('def', 'hotel', 'checkin', 'yajin', 3, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(6)', '', '', 'select,insert,update,references', ''),
('def', 'hotel', 'checkin', 'xiaofei', 4, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(6)', '', '', 'select,insert,update,references', ''),
('def', 'hotel', 'checkin', 'time_in', 5, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'hotel', 'checkin', 'time_out', 6, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'hotel', 'checkin', 'room_name', 7, NULL, 'YES', 'varchar', 6, 18, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(6)', '', '', 'select,insert,update,references', ''),
('def', 'hotel', 'checkin', 'name', 8, NULL, 'NO', 'varchar', 6, 18, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(6)', '', '', 'select,insert,update,references', ''),
('def', 'hotel', 'checkin', 'id', 9, NULL, 'NO', 'varchar', 13, 39, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(13)', '', '', 'select,insert,update,references', ''),
('def', 'hotel', 'checkin', 'benjin', 10, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'hotel', 'checkin', 'time', 11, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'hotel', 'checkin', 'order_id', 12, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'hotel', 'room', 'name', 1, NULL, 'NO', 'varchar', 6, 18, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(6)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'hotel', 'room', 'mianji', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(4)', '', '', 'select,insert,update,references', ''),
('def', 'hotel', 'room', 'chuangwei', 3, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(2)', '', '', 'select,insert,update,references', ''),
('def', 'hotel', 'room', 'kongtiao', 4, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(2)', '', '', 'select,insert,update,references', ''),
('def', 'hotel', 'room', 'dianshi', 5, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(2)', '', '', 'select,insert,update,references', ''),
('def', 'hotel', 'room', 'cesuo', 6, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(2)', '', '', 'select,insert,update,references', ''),
('def', 'hotel', 'room', 'err', 7, NULL, 'NO', 'varchar', 40, 120, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(40)', '', '', 'select,insert,update,references', ''),
('def', 'hotel', 'room', 'price', 8, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(5)', '', '', 'select,insert,update,references', ''),
('def', 'hotel', 'room', 'checkin', 9, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(4)', '', '', 'select,insert,update,references', ''),
('def', 'hotel', 'room', 'dress', 10, NULL, 'NO', 'varchar', 15, 45, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(15)', '', '', 'select,insert,update,references', ''),
('def', 'hotel', 'room', 'type', 11, NULL, 'NO', 'varchar', 15, 45, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(15)', '', '', 'select,insert,update,references', ''),
...
('COM_SLAVE_STOP', '0'),
('COM_STMT_CLOSE', '1504'),
('COM_STMT_EXECUTE', '1504'),
('COM_STMT_FETCH', '0'),
('COM_STMT_PREPARE', '1505'),
...
('THREADS_RUNNING', '1'),
('UPTIME', '40132'),
('UPTIME_SINCE_FLUSH_STATUS', '40132');
...
('THREAD_CACHE_SIZE', '8'),
('LC_MESSAGES_DIR', 'E:\\phpstudy\\MySQL\\share\\'),
('SYNC_FRM', 'ON'),
...
('GENERAL_LOG_FILE', 'E:\\phpstudy\\MySQL\\data\\DESKTOP-IC22OQV.log'),
('OLD_PASSWORDS', 'OFF'),
...
('UNIQUE_CHECKS', 'ON'),
('PID_FILE', 'E:\\phpstudy\\MySQL\\data\\DESKTOP-IC22OQV.pid'),
('VERSION', '5.5.53'),
...
('SLOW_QUERY_LOG_FILE', 'E:\\phpstudy\\MySQL\\data\\DESKTOP-IC22OQV-slow.log'),
('LOG_BIN', 'OFF'),
('SSL_CA', ''),
...
('PLUGIN_DIR', 'E:\\phpstudy\\MySQL\\lib\\plugin\\'),
...
('def', 'hotel', 'PRIMARY', 'def', 'hotel', 'admin', 'admin_name', 1, NULL, NULL, NULL, NULL),
('def', 'hotel', 'PRIMARY', 'def', 'hotel', 'checkin', 'order_id', 1, NULL, NULL, NULL, NULL),
('def', 'hotel', 'PRIMARY', 'def', 'hotel', 'room', 'name', 1, NULL, NULL, NULL, NULL),
('def', 'hotel', 'name', 'def', 'hotel', 'room', 'name', 1, NULL, NULL, NULL, NULL),
...
('def', 'information_schema', 'CHARACTER_SETS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 384, 0, 16604160, 0, 0, '2017-05-08 11:42:47', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 231, 0, 16704765, 0, 0, '2017-05-08 11:42:47', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 195, 0, 16691610, 0, 0, '2017-05-08 11:42:47', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMNS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-05-08 11:42:47', '2017-05-08 11:42:47', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMN_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2565, 0, 16757145, 0, 0, '2017-05-08 11:42:47', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ENGINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 490, 0, 16709000, 0, 0, '2017-05-08 11:42:47', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'EVENTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-05-08 11:42:47', '2017-05-08 11:42:47', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'FILES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2677, 0, 16758020, 0, 0, '2017-05-08 11:42:47', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2017-05-08 11:42:47', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2017-05-08 11:42:47', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'KEY_COLUMN_USAGE', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4637, 0, 16762755, 0, 0, '2017-05-08 11:42:47', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARAMETERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-05-08 11:42:47', '2017-05-08 11:42:47', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARTITIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-05-08 11:42:47', '2017-05-08 11:42:47', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PLUGINS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-05-08 11:42:47', '2017-05-08 11:42:47', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROCESSLIST', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-05-08 11:42:47', '2017-05-08 11:42:47', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROFILING', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 308, 0, 16562084, 0, 0, '2017-05-08 11:42:47', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4814, 0, 16767162, 0, 0, '2017-05-08 11:42:47', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ROUTINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-05-08 11:42:47', '2017-05-08 11:42:47', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMATA', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3464, 0, 16755368, 0, 0, '2017-05-08 11:42:47', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2179, 0, 16767405, 0, 0, '2017-05-08 11:42:47', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2017-05-08 11:42:47', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2017-05-08 11:42:47', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'STATISTICS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 5753, 0, 16764242, 0, 0, '2017-05-08 11:42:47', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 9450, 0, 16764300, 0, 0, '2017-05-08 11:42:47', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLESPACES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 6951, 0, 16772763, 0, 0, '2017-05-08 11:42:47', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2504, 0, 16749256, 0, 0, '2017-05-08 11:42:47', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2372, 0, 16748692, 0, 0, '2017-05-08 11:42:47', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TRIGGERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-05-08 11:42:47', '2017-05-08 11:42:47', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'USER_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 1986, 0, 16759854, 0, 0, '2017-05-08 11:42:47', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'VIEWS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-05-08 11:42:47', '2017-05-08 11:42:47', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_BUFFER_PAGE', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 6852, 0, 16766844, 0, 0, '2017-05-08 11:42:48', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_TRX', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4534, 0, 16766732, 0, 0, '2017-05-08 11:42:48', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_BUFFER_POOL_STATS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 257, 0, 16583439, 0, 0, '2017-05-08 11:42:48', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCK_WAITS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 599, 0, 16749238, 0, 0, '2017-05-08 11:42:48', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 15204352, 0, 0, '2017-05-08 11:42:48', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 14979650, 0, 0, '2017-05-08 11:42:48', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCKS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 31244, 0, 16746784, 0, 0, '2017-05-08 11:42:48', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 15204352, 0, 0, '2017-05-08 11:42:48', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 14979650, 0, 0, '2017-05-08 11:42:48', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_BUFFER_PAGE_LRU', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 6669, 0, 16765866, 0, 0, '2017-05-08 11:42:48', NULL, NULL, NULL, '', '', NULL),
('def', 'hotel', 'admin', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 72, 308, 281474976710655, 8192, 164, '2017-04-22 04:09:35', '2017-05-06 09:15:58', NULL, NULL, '', '', NULL),
('def', 'hotel', 'checkin', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 66, 132, 281474976710655, 2048, 0, '2017-05-08 01:04:54', '2017-05-08 07:44:06', NULL, NULL, '', '', NULL),
('def', 'hotel', 'room', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4, 70, 352, 281474976710655, 3072, 72, '2017-05-06 01:04:10', '2017-05-08 08:03:55', NULL, NULL, '', '', NULL),
...
('def', 'mysql', 'user', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 104, 316, 281474976710655, 2048, 108, '2015-11-09 17:41:24', '2017-03-26 02:17:43', NULL, NULL, '', '', NULL),
...
(468, 'root', 'localhost:51814', 'hotel', 'Query', 0, 'executing', 'SELECT * FROM `information_schema`.`PROCESSLIST`');
...
('def', 'hotel', 'utf8', 'utf8_general_ci', NULL),
...
('THREADS_RUNNING', '1'),
('UPTIME', '40133'),
('UPTIME_SINCE_FLUSH_STATUS', '40133');
...
('def', 'hotel', 'admin', 0, 'hotel', 'PRIMARY', 1, 'admin_name', 'A', 2, NULL, NULL, '', 'BTREE', '', ''),
('def', 'hotel', 'checkin', 0, 'hotel', 'PRIMARY', 1, 'order_id', 'A', 2, NULL, NULL, '', 'BTREE', '', ''),
('def', 'hotel', 'room', 0, 'hotel', 'PRIMARY', 1, 'name', 'A', 4, NULL, NULL, '', 'BTREE', '', ''),
('def', 'hotel', 'room', 0, 'hotel', 'name', 1, 'name', 'A', 4, NULL, NULL, '', 'BTREE', '', ''),
...
('def', 'information_schema', 'CHARACTER_SETS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 384, 0, 16604160, 0, 0, NULL, '2017-05-08 11:42:48', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=43690', ''),
('def', 'information_schema', 'COLLATIONS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 231, 0, 16704765, 0, 0, NULL, '2017-05-08 11:42:48', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=72628', ''),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 195, 0, 16691610, 0, 0, NULL, '2017-05-08 11:42:48', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=86037', ''),
('def', 'information_schema', 'COLUMNS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-05-08 11:42:48', '2017-05-08 11:42:48', NULL, 'utf8_general_ci', NULL, 'max_rows=3153', ''),
('def', 'information_schema', 'COLUMN_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2565, 0, 16757145, 0, 0, NULL, '2017-05-08 11:42:48', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6540', ''),
('def', 'information_schema', 'ENGINES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 490, 0, 16709000, 0, 0, NULL, '2017-05-08 11:42:48', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=34239', ''),
('def', 'information_schema', 'EVENTS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-05-08 11:42:48', '2017-05-08 11:42:48', NULL, 'utf8_general_ci', NULL, 'max_rows=696', ''),
('def', 'information_schema', 'FILES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2677, 0, 16758020, 0, 0, NULL, '2017-05-08 11:42:48', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6267', ''),
('def', 'information_schema', 'GLOBAL_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2017-05-08 11:42:48', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'GLOBAL_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2017-05-08 11:42:48', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'KEY_COLUMN_USAGE', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4637, 0, 16762755, 0, 0, NULL, '2017-05-08 11:42:48', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3618', ''),
('def', 'information_schema', 'PARAMETERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-05-08 11:42:48', '2017-05-08 11:42:48', NULL, 'utf8_general_ci', NULL, 'max_rows=6806', ''),
('def', 'information_schema', 'PARTITIONS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-05-08 11:42:48', '2017-05-08 11:42:48', NULL, 'utf8_general_ci', NULL, 'max_rows=6276', ''),
('def', 'information_schema', 'PLUGINS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-05-08 11:42:48', '2017-05-08 11:42:48', NULL, 'utf8_general_ci', NULL, 'max_rows=12744', ''),
('def', 'information_schema', 'PROCESSLIST', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-05-08 11:42:48', '2017-05-08 11:42:48', NULL, 'utf8_general_ci', NULL, 'max_rows=26886', ''),
('def', 'information_schema', 'PROFILING', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 308, 0, 16562084, 0, 0, NULL, '2017-05-08 11:42:48', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=54471', ''),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4814, 0, 16767162, 0, 0, NULL, '2017-05-08 11:42:48', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3485', ''),
('def', 'information_schema', 'ROUTINES', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-05-08 11:42:48', '2017-05-08 11:42:48', NULL, 'utf8_general_ci', NULL, 'max_rows=656', ''),
('def', 'information_schema', 'SCHEMATA', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3464, 0, 16755368, 0, 0, NULL, '2017-05-08 11:42:48', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=4843', ''),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2179, 0, 16767405, 0, 0, NULL, '2017-05-08 11:42:48', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7699', ''),
('def', 'information_schema', 'SESSION_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2017-05-08 11:42:48', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'SESSION_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2017-05-08 11:42:48', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'STATISTICS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 5753, 0, 16764242, 0, 0, NULL, '2017-05-08 11:42:48', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2916', ''),
('def', 'information_schema', 'TABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 9450, 0, 16764300, 0, 0, NULL, '2017-05-08 11:42:48', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=1775', ''),
('def', 'information_schema', 'TABLESPACES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 6951, 0, 16772763, 0, 0, NULL, '2017-05-08 11:42:48', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2413', ''),
('def', 'information_schema', 'TABLE_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2504, 0, 16749256, 0, 0, NULL, '2017-05-08 11:42:48', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6700', ''),
('def', 'information_schema', 'TABLE_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2372, 0, 16748692, 0, 0, NULL, '2017-05-08 11:42:48', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7073', ''),
('def', 'information_schema', 'TRIGGERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-05-08 11:42:48', '2017-05-08 11:42:48', NULL, 'utf8_general_ci', NULL, 'max_rows=640', ''),
('def', 'information_schema', 'USER_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 1986, 0, 16759854, 0, 0, NULL, '2017-05-08 11:42:48', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=8447', ''),
('def', 'information_schema', 'VIEWS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-05-08 11:42:48', '2017-05-08 11:42:48', NULL, 'utf8_general_ci', NULL, 'max_rows=7802', ''),
('def', 'information_schema', 'INNODB_BUFFER_PAGE', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 6852, 0, 16766844, 0, 0, NULL, '2017-05-08 11:42:48', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2448', ''),
('def', 'information_schema', 'INNODB_TRX', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4534, 0, 16766732, 0, 0, NULL, '2017-05-08 11:42:48', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3700', ''),
('def', 'information_schema', 'INNODB_BUFFER_POOL_STATS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 257, 0, 16583439, 0, 0, NULL, '2017-05-08 11:42:48', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=65280', ''),
('def', 'information_schema', 'INNODB_LOCK_WAITS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 599, 0, 16749238, 0, 0, NULL, '2017-05-08 11:42:48', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=28008', ''),
('def', 'information_schema', 'INNODB_CMPMEM', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 15204352, 0, 0, NULL, '2017-05-08 11:42:48', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=578524', ''),
('def', 'information_schema', 'INNODB_CMP', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 14979650, 0, 0, NULL, '2017-05-08 11:42:48', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=671088', ''),
('def', 'information_schema', 'INNODB_LOCKS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 31244, 0, 16746784, 0, 0, NULL, '2017-05-08 11:42:48', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=536', ''),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 15204352, 0, 0, NULL, '2017-05-08 11:42:48', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=578524', ''),
('def', 'information_schema', 'INNODB_CMP_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 14979650, 0, 0, NULL, '2017-05-08 11:42:48', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=671088', ''),
('def', 'information_schema', 'INNODB_BUFFER_PAGE_LRU', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 6669, 0, 16765866, 0, 0, NULL, '2017-05-08 11:42:48', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2515', ''),
('def', 'hotel', 'admin', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 2, 72, 308, 281474976710655, 8192, 164, NULL, '2017-04-22 04:09:35', '2017-05-06 09:15:58', NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'hotel', 'checkin', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 2, 66, 132, 281474976710655, 2048, 0, 3, '2017-05-08 01:04:54', '2017-05-08 07:44:06', NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'hotel', 'room', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 4, 70, 352, 281474976710655, 3072, 72, NULL, '2017-05-06 01:04:10', '2017-05-08 08:03:55', NULL, 'utf8_general_ci', NULL, '', ''),
...
('def', 'mysql', 'user', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 2, 104, 316, 281474976710655, 2048, 108, NULL, '2015-11-09 17:41:24', '2017-03-26 02:17:43', NULL, 'utf8_bin', NULL, '', 'Users and global privileges'),
...
('def', 'hotel', 'PRIMARY', 'hotel', 'admin', 'PRIMARY KEY'),
('def', 'hotel', 'PRIMARY', 'hotel', 'checkin', 'PRIMARY KEY'),
('def', 'hotel', 'PRIMARY', 'hotel', 'room', 'PRIMARY KEY'),
('def', 'hotel', 'name', 'hotel', 'room', 'UNIQUE'),
